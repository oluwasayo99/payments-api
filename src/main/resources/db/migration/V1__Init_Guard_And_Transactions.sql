...
CREATE TABLE transactions (
      id BIGINT IDENTITY(1,1) PRIMARY KEY,           -- @Id with GenerationType.IDENTITY
      ...
      transaction_date DATETIME2 NOT NULL,           -- LocalDateTime
      created_at DATETIME2 DEFAULT CURRENT_TIMESTAMP, -- Creation timestamp
      updated_at DATETIME2,                           -- Update timestamp (handle via Java/Hibernate)
